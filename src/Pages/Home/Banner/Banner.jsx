...
const Banner = () => {
    return (
        <div className="md:mx-auto mb-4">
            ...
            <div className="absolute top-[15%] right-[15%] lg:top-[300px] lg:right-[360px] ">
                ...
                <Link to={'/alljob'} className="btn max-[450px]:btn-sm lg:btn-wide bg-[#1E83F0] btn-outline border-[#1E83F0] hover:bg-transparent hover:border-[#1E83F0] text-white ">See our curated Jobs</Link>
                </div>
            </div>
        </div>
        </div>
